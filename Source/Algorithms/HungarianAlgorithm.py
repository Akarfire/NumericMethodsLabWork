...
class HungarianAlgorithm(Algorithm):
    ...
    def run(input_data: Data) -> None:
        ...
        row_ind, col_ind = linear_sum_assignment(transposed_matrix, maximize=True)
        ...
        input_data.statistics.sugarity_data_per_algorithm[AlgorithmNames.HUNGARIAN] = sugarity_per_stage
